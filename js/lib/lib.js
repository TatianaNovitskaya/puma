    ...
    $.fn.niceSelect = function (method) {
        ...
        $(document).on('click.nice_select', '.nice-select', function (event) {
            ...
            if ($dropdown.hasClass('open')) {
                ...
                stateOpenedSelect = true;
            } else {
                $dropdown.focus();
                stateOpenedSelect = false;
            }

            if ($dropdownList[0].getBoundingClientRect().top < 0) {
                $dropdownList.addClass('list-bottom')
            } else {
                setTimeout(function () {
                    if (!stateOpenedSelect) {
                        $dropdownList.removeClass('list-bottom')
                    }
                },500)
            }
        });
